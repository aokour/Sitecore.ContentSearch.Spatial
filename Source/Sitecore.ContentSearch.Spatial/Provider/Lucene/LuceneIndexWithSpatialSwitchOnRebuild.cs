...
{
    public class LuceneIndexWithSpatialSwitchOnRebuild : SwitchOnRebuildLuceneIndex
    {
        public LuceneIndexWithSpatialSwitchOnRebuild(string name, string folder, IIndexPropertyStore propertyStore)
